...
export const SINGLE_SERVER_SPECS =
  /(position|overlay|anchored|reduced-motion|toast|skeleton|navigation|data|nesting|numeric|confirm|form|date|tree|cascader|upload|splitter|watermark)\.spec\.ts$/;
